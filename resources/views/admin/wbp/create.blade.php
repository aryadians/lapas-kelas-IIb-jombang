...
<div class="space-y-8 animated-form">
    ...
    <div class="form-group">
        ...
        <h1 class="text-3xl font-bold text-slate-800">📋 Tambah Data Warga Binaan Baru</h1>
        <p class="text-slate-500 text-sm mt-1">Isi formulir di bawah ini untuk menambahkan WBP ke dalam sistem.</p>
    </div>

    <div class="bg-white rounded-2xl shadow-2xl border border-slate-200 form-group">
        <form action="{{ route('admin.wbp.store') }}" method="POST">
            @csrf
            <div class="p-8">
                <div class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="relative form-group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="nama" name="nama" class="form-input" value="{{ old('nama') }}" required placeholder="Contoh: John Doe">
                            </div>
                        ...
                        <div class="relative form-group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="no_registrasi" name="no_registrasi" class="form-input" value="{{ old('no_registrasi') }}" required placeholder="Contoh: WBP-JMB-2024-001">
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="relative form-group">
                            ...
                            <div class="relative">
                                ...
                                <input type="date" id="tanggal_masuk" name="tanggal_masuk" class="form-input" value="{{ old('tanggal_masuk') }}">
                            </div>
                        ...
                        <div class="relative form-group">
                            ...
                            <div class="relative">
                                ...
                                <input type="date" id="tanggal_ekspirasi" name="tanggal_ekspirasi" class="form-input" value="{{ old('tanggal_ekspirasi') }}">
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="relative form-group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="blok" name="blok" class="form-input" value="{{ old('blok') }}" placeholder="Contoh: A">
                            </div>
            ...
            <div class="flex justify-end items-center gap-4 p-6 bg-slate-50/50 border-t border-slate-200 rounded-b-2xl form-group">
                ...
                <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2.5 px-8 rounded-lg shadow-lg hover:shadow-indigo-500/50 transform hover:-translate-y-1 transition-all duration-300">
