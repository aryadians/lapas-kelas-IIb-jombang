    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <form action="{{ route('admin.broadcast.update', $template->id) }}" method="POST" class="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 space-y-4">
            ...
            <div>
                ...
                <textarea name="whatsapp_body" class="w-full p-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:border-blue-500 focus:ring-0" rows="5">{{ $template->whatsapp_body }}</textarea>
            ...
            <div>
                ...
                <textarea name="email_body" class="w-full p-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:border-blue-500 focus:ring-0" rows="6">{{ $template->email_body }}</textarea>
            </div>
