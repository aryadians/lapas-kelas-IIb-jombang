...
<body class="bg-gray-100" x-data="{ sidebarOpen: false }">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
               class="fixed inset-y-0 left-0 z-50 w-72 bg-slate-900 text-white flex flex-col shadow-2xl transition-transform duration-300 md:translate-x-0 md:static md:inset-0">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                <a href="{{ route('dashboard') }}" 
                   class="flex items-center px-4 py-3 {{ request()->routeIs('dashboard') ? 'bg-blue-900 text-white border-l-4 border-yellow-500 shadow-lg' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }} rounded-xl transition-colors">
                ...
                <a href="{{ route('news.index') }}" 
                   class="flex items-center px-4 py-3 {{ request()->routeIs('news.*') ? 'bg-blue-900 text-white border-l-4 border-yellow-500 shadow-lg' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }} rounded-xl transition-colors">
                ...
                <a href="{{ route('announcements.index') }}" 
                   class="flex items-center px-4 py-3 {{ request()->routeIs('announcements.*') ? 'bg-blue-900 text-white border-l-4 border-yellow-500 shadow-lg' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }} rounded-xl transition-colors">
                ...
                <a href="{{ route('admin.kunjungan.index') }}" 
                   class="flex items-center px-4 py-3 {{ request()->routeIs('admin.kunjungan.*') ? 'bg-blue-900 text-white border-l-4 border-yellow-500 shadow-lg' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }} rounded-xl transition-colors">
                ...
                <a href="{{ route('admin.users.index') }}" 
                   class="flex items-center px-4 py-3 {{ request()->routeIs('admin.users.*') ? 'bg-blue-900 text-white border-l-4 border-yellow-500 shadow-lg' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }} rounded-xl transition-colors">
                ...
                <a href="{{ route('wbp.index') }}" 
                   class="flex items-center px-4 py-3 {{ request()->routeIs('wbp.*') ? 'bg-blue-900 text-white border-l-4 border-yellow-500 shadow-lg' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }} rounded-xl transition-colors">
                    <svg class="w-6 h-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    function confirmUpdate(event, status, itemName = '') {
        ...
        Swal.fire({
            ...
            text: `Anda akan ${isApproved ? 'menyetujui' : 'menolak'} kunjungan untuk "${itemName}". Lanjutkan?`,
    ...
    function confirmBulkAction(event, action, status = null) {
        ...
        if (selectedIds.length === 0) {
            Swal.fire({ ...swalTheme, title: 'Tidak Ada Data Terpilih', text: 'Silakan pilih setidaknya satu item.', icon: 'info' });
            return;
        }
