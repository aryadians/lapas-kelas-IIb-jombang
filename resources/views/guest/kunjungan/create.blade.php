                    ...
                    <div class="space-y-4 flex-grow">
                        ...
                        <div class="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg border-l-4 border-blue-500 hover:shadow-md transition-all duration-300 hover:from-blue-100 hover:to-blue-200">
                            ...
                            <div class="text-sm text-slate-600 space-y-1">
                                <!-- Asumsi: Jika ada kuota online pagi, berarti sesi pagi buka untuk pendaftaran online. -->
                                ...
                                @endif
                                @if($schedule->quota_online_morning == 0 && $schedule->quota_online_afternoon == 0)
                                <div class="flex justify-between"><span>Sesi Layanan:</span> <strong class="text-red-600">Pendaftaran Online Tutup</strong></div>
                                @endif
                            </div>
                        </div>
                        @endforeach
